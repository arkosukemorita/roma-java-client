...
import jp.co.rakuten.rit.roma.client.commands.GetsOptCommand.CallableImpl;
import jp.co.rakuten.rit.roma.client.routing.New_RoutingTable;
import jp.co.rakuten.rit.roma.client.routing.RoutingTable;

public class New_GetsOptCommandImpl extends New_AbstractCommandImpl implements
	CommandID {

    public New_GetsOptCommandImpl() {
	super(null);
    }
