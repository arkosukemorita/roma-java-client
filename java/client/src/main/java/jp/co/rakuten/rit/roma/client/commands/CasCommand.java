...
public class CasCommand extends AbstractCommand implements CommandID {
	...
	sb.append(STR_CAS).append(STR_WHITE_SPACE).append(
		...
		.append(STR_WHITE_SPACE).append(
			context.get(CommandContext.CAS_ID)).append(STR_CRLF);
	...
	if (ret.startsWith("STORED")) {
		...
		|| ret.startsWith("CLENT_ERROR") || ret.startsWith("ERROR")) {
