...
public class New_AbstractExpiredCommand extends New_UpdateCommand {

    public New_AbstractExpiredCommand() {
	super(null);
    }
	...
	// alist_expired_swap_and_insert/push <key> <expire-time> <bytes>\r\n
	// <value>\r\n
