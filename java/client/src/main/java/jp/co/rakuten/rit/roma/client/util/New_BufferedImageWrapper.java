 ...
 * 
 */
public class New_BufferedImageWrapper {

    protected New_RomaClient client;
    protected String format; // e.g. "jpeg"

    public New_BufferedImageWrapper(New_RomaClient client) {
	this.client = client;
    }
    ...
    public boolean put(String key, BufferedImage image, long expiry)
	    throws ClientException, IOException {
	if (format == null || format.equals("")) {
	    format = "jpg";
	}
