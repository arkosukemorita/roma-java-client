...
public interface New_RomaClient {
    ...
    void setRoutingTable(New_RoutingTable routingTable);

    New_RoutingTable getRoutingTable();

    void setCommandFactory(New_CommandFactory commandFactory);

    New_CommandFactory getCommandFactory();
