 ...
 * 
 */
class New_StringListAdaptor1Impl implements New_StringListAdaptor {

    private static final String SEP = "_"; // "_$_$_";
    private static final String SEP2 = ","; // "_$,$_";
    private int listSize;
    private long expiry;
    protected New_StringWrapper sWrapper;

    New_StringListAdaptor1Impl(New_StringWrapper wrapper) throws ClientException {
    ...
    public void setStringWrapper(New_StringWrapper wrapper) {
        this.sWrapper = wrapper;
    }
    ...
    private static List<String> getRawList(New_StringWrapper sWrapper,
