 ...
 * 
 */
public class New_RoutingTable {

    private static final String DIGEST_ALGORITHM_SHA1 = "SHA1";
    private static final String ZERO = "0";
    private static final String ONE = "1";
    private static final String TWO = "2";
    private New_RomaClient client;
    private New_RoutingInfoUpdatingThread thread;
    ...
    public New_RoutingTable(New_RomaClient client) {
        this.client = client;
    ...
    public synchronized void startLoop() {
        loopEnabled = true;
        thread = new New_RoutingInfoUpdatingThread(this);
        thread.doStart();
    }
