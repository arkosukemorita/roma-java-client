...
public class AbstractIncrAndDecrCommand extends AbstractCommand implements
	CommandID {

    public AbstractIncrAndDecrCommand() {
	super(null);
    }

    public AbstractIncrAndDecrCommand(Command command) {
	super(command);
    }
	...
	sb.append(getCommand()).append(STR_WHITE_SPACE).append(
		...
		.append(context.get(CommandContext.VALUE)).append(STR_CRLF);
