...
public class New_TimeoutCommand extends New_AbstractCommand {
	...
	private New_Command command;
	private CommandContext context;

	public CallableImpl(New_Command command, CommandContext context) {
    ...
    public New_TimeoutCommand(New_Command command) {
	super(command);
    }
