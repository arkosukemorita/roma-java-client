...
import jp.co.rakuten.rit.roma.client.util.New_StringListWrapper;
import junit.framework.TestCase;

public class New_PerfTest3 extends TestCase {
    private static String NODE_ID = New_AllTests.NODE_ID;

    private static String KEY_PREFIX1 = New_PerfTest3.class.getName() + "1";

    private static String KEY_PREFIX2 = New_PerfTest3.class.getName() + "2";

    private static String KEY_PREFIX3 = New_PerfTest3.class.getName() + "3";

    private static New_RomaClient CLIENT = null;

    private static New_StringListWrapper LISTUTIL2 = null;
	...
	LISTUTIL2 = new New_StringListWrapper(CLIENT, true, 15);
	CLIENT.open(nodes);
	...
	New_PerfTest3 test = new New_PerfTest3();
	test.setUp();
