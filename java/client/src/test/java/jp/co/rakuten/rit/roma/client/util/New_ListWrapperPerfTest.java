...
public class New_ListWrapperPerfTest extends TestCase {
    private static String NODE_ID = New_AllTests.NODE_ID;

    private static String KEY_PREFIX = New_ListWrapperPerfTest.class.getName();
    ...
    public New_ListWrapperPerfTest() {
	super();
    }
