...
public class ObjectWrapperTest_longExpire extends TestCase {

    private static String NODE_ID = AllTests.NODE_ID;

    private static String KEY_PREFIX = ObjectWrapperTest_longExpire.class
	    .getName();
    ...
    public ObjectWrapperTest_longExpire() {
	super();
    }
