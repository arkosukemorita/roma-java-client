...
public class TimeoutCommandPerfTest extends TestCase {
    private static String NODE_ID = AllTests.NODE_ID;

    private static String KEY_PREFIX = TimeoutCommandPerfTest.class.getName();
    ...
    public void testPutLoop01() throws Exception {
	big_loop();
	assertTrue(true);
    }
