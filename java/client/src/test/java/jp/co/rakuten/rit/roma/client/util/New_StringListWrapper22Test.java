...
public class New_StringListWrapper22Test extends TestCase {
	private static String NODE_ID = New_AllTests.NODE_ID;

	private static String KEY_PREFIX = New_StringListWrapper22Test.class.getName();
	...
	public New_StringListWrapper22Test() {
		super();
	}
