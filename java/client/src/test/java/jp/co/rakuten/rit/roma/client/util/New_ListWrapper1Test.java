...
public class New_ListWrapper1Test extends TestCase {
    private static String NODE_ID = New_AllTests.NODE_ID;

    private static String KEY_PREFIX = New_ListWrapper1Test.class.getName();
	...
	try {
	    LISTUTIL = new New_ListWrapper(CLIENT, -1);
	    fail();
	} catch (Exception e) {
	...
	long expiry = 1;
	LISTUTIL = new New_ListWrapper(CLIENT, expiry);
	...
	int size = 3;
	long expiry = 1;
	LISTUTIL = new New_ListWrapper(CLIENT, size, expiry);
