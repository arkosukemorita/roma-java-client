...
public class New_StringListWrapper11Test extends TestCase {
    private static String NODE_ID = New_AllTests.NODE_ID;

    private static String KEY_PREFIX = New_StringListWrapper11Test.class.getName();
    ...
    public New_StringListWrapper11Test() {
	super();
    }
	...
	LISTUTIL = new New_StringListWrapper(CLIENT, false, 3);
	assertTrue(LISTUTIL.append(KEY, "01"));
	assertTrue(LISTUTIL.append(KEY, "02"));
	assertTrue(LISTUTIL.append(KEY, "03"));
	...
	try {
	    LISTUTIL = new New_StringListWrapper(CLIENT, false, -1);
	    fail();
	} catch (Exception e) {
	...
	long expiry = 1;
	LISTUTIL = new New_StringListWrapper(CLIENT, false, expiry);
	...
	int size = 3;
	long expiry = 1;
	LISTUTIL = new New_StringListWrapper(CLIENT, false, size, expiry);
