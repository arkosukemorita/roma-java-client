...
public class New_StringListWrapper21Test extends TestCase {

    private static String NODE_ID = New_AllTests.NODE_ID;

    private static String KEY_PREFIX = New_StringListWrapper21Test.class.getName();
    ...
    public New_StringListWrapper21Test() {
	super();
    }
	...
	LISTUTIL = new New_StringListWrapper(CLIENT, true);
	...
	try {
	    LISTUTIL = new New_StringListWrapper(CLIENT, true, -1);
	    fail();
	} catch (Exception e) {
	...
	long expiry = 1;
	LISTUTIL = new New_StringListWrapper(CLIENT, true, expiry);
	...
	int size = 3;
	long expiry = 1;
	LISTUTIL = new New_StringListWrapper(CLIENT, true, size, expiry);
