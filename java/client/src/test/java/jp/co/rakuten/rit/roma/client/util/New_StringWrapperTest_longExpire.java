...
public class New_StringWrapperTest_longExpire extends TestCase {

    private static String NODE_ID = New_AllTests.NODE_ID;

	private static String KEY_PREFIX = New_StringWrapperTest_longExpire.class.getName();

	private static New_RomaClient CLIENT = null;

	private static New_StringWrapper APPENDER = null;

	private static String KEY = null;

	public New_StringWrapperTest_longExpire() {
		super();
	}
	...
	public void setUp() throws Exception {
		...
		APPENDER = new New_StringWrapper(CLIENT);
...
//		assertTrue(APPENDER.append(KEY, "03", new Date(2000)));
		assertTrue(APPENDER.append(KEY, "03", 2));
...
//		assertTrue(APPENDER.prepend(KEY, "03", new Date(2000)));
		assertTrue(APPENDER.prepend(KEY, "03", 2));
