...
public class New_RomaClientImplTest extends TestCase {

    private static String NODE_ID = New_AllTests.NODE_ID;

    private static String KEY_PREFIX = New_RomaClientImplTest.class.getName();

    private static New_RomaClient CLIENT = null;

    private static String KEY = null;

    public New_RomaClientImplTest() {
	super();
    }
