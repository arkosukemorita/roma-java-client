...
public class New_RomaClientImplTest_longExpire extends TestCase {

    private static String NODE_ID = New_AllTests.NODE_ID;

    private static String KEY_PREFIX = New_RomaClientImplTest_longExpire.class.getName();

    private static New_RomaClient CLIENT = null;

    private static String KEY = null;

    public New_RomaClientImplTest_longExpire() {
	super();
    }
