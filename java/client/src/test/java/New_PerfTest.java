...
public class New_PerfTest extends TestCase {
    private static String NODE_ID = New_AllTests.NODE_ID;

    private static String KEY_PREFIX1 = New_PerfTest.class.getName() + "1";
	...
	New_PerfTest test = new New_PerfTest();
	test.setUp();
//	Xtest.testDeleteAndPrependLoop02();
//	Xtest.testDeleteAndPrependLoop01();
	test.tearDown();
    }
}